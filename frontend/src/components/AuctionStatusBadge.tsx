...
// Scheduled is a real, internal-only status -- this just renders whatever
// the backend computed. It never has to decide when Scheduled is "allowed"
// to show; that's already handled server-side.
